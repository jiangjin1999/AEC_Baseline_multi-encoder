...
from model.models import (BartForConditionalGeneration, Multi_encoder_Seq2seq)
    ...
    def train_epoch(self):
        ...
        for text_batch in self.train_dataloader:
            ...
            output: Seq2SeqLMOutput = self.model(
                source_input_ids=input_ids, context_input_ids=input_ids, labels=labels)
    ...
    def evaluate(self, dataloader,):
        ...
        for text_batch in dataloader:
            with torch.no_grad():
                ...
                Output: Seq2SeqLMOutput = self.model(
                    source_input_ids=input_ids, context_input_ids=input_ids)
...
if __name__ == "__main__":
    ...
    trainer = Trainer(
        ...
        model=Multi_encoder_Seq2seq.from_pretrained(config.pretrained_model),
